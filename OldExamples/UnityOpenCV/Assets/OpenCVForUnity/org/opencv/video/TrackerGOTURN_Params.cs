...
namespace OpenCVForUnity.VideoModule
{
    ...
    public class TrackerGOTURN_Params : DisposableOpenCVObject
    {
        ...
        public string get_modelTxt()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(video_TrackerGOTURN_1Params_get_1modelTxt_10(nativeObj)));
        ...
        public string get_modelBin()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(video_TrackerGOTURN_1Params_get_1modelBin_10(nativeObj)));
            string retVal = Marshal.PtrToStringAnsi(strPtr);
            UnityIntegration.OpenCVInternalUtils.FreeStringCopy(strPtr);
