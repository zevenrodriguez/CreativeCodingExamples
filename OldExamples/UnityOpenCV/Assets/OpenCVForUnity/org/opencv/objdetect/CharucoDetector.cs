...
namespace OpenCVForUnity.ObjdetectModule
{
    ...
    public class CharucoDetector : Algorithm
    {
        ...
        public CharucoDetector(CharucoBoard board, CharucoParameters charucoParams, DetectorParameters detectorParams, RefineParameters refineParams) :
                    base(DisposableObject.ThrowIfNullIntPtr(objdetect_CharucoDetector_CharucoDetector_10(board.getNativeObjAddr(), charucoParams.getNativeObjAddr(), detectorParams.getNativeObjAddr(), refineParams.getNativeObjAddr())))
        {
        ...
        public CharucoDetector(CharucoBoard board, CharucoParameters charucoParams, DetectorParameters detectorParams) :
                    base(DisposableObject.ThrowIfNullIntPtr(objdetect_CharucoDetector_CharucoDetector_11(board.getNativeObjAddr(), charucoParams.getNativeObjAddr(), detectorParams.getNativeObjAddr())))
        {
        ...
        public CharucoDetector(CharucoBoard board, CharucoParameters charucoParams) :
                    base(DisposableObject.ThrowIfNullIntPtr(objdetect_CharucoDetector_CharucoDetector_12(board.getNativeObjAddr(), charucoParams.getNativeObjAddr())))
        {
        ...
        public CharucoDetector(CharucoBoard board) :
                    base(DisposableObject.ThrowIfNullIntPtr(objdetect_CharucoDetector_CharucoDetector_13(board.getNativeObjAddr())))
        {
        ...
        public void setBoard(CharucoBoard board)
        {
            ...
            objdetect_CharucoDetector_setBoard_10(nativeObj, board.getNativeObjAddr());
        ...
        public void setCharucoParameters(CharucoParameters charucoParameters)
        {
            ...
            objdetect_CharucoDetector_setCharucoParameters_10(nativeObj, charucoParameters.getNativeObjAddr());
        ...
        public void setDetectorParameters(DetectorParameters detectorParameters)
        {
            ...
            objdetect_CharucoDetector_setDetectorParameters_10(nativeObj, detectorParameters.getNativeObjAddr());
        ...
        public void setRefineParameters(RefineParameters refineParameters)
        {
            ...
            objdetect_CharucoDetector_setRefineParameters_10(nativeObj, refineParameters.getNativeObjAddr());
