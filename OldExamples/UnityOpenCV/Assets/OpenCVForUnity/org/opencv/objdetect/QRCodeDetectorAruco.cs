...
namespace OpenCVForUnity.ObjdetectModule
{
    ...
    public class QRCodeDetectorAruco : GraphicalCodeDetector
    {
        ...
        public QRCodeDetectorAruco(QRCodeDetectorAruco_Params _params) :
                    base(DisposableObject.ThrowIfNullIntPtr(objdetect_QRCodeDetectorAruco_QRCodeDetectorAruco_11(_params.getNativeObjAddr())))
        {
        ...
        public QRCodeDetectorAruco setDetectorParameters(QRCodeDetectorAruco_Params _params)
        {
            ...
            return new QRCodeDetectorAruco(DisposableObject.ThrowIfNullIntPtr(objdetect_QRCodeDetectorAruco_setDetectorParameters_10(nativeObj, _params.getNativeObjAddr())));
