...
namespace OpenCVForUnity.Features2dModule
{
    ...
    public class Feature2D : Algorithm
    {
        ...
        public void detect(List<Mat> images, List<MatOfKeyPoint> keypoints, List<Mat> masks)
        {
            ...
            using Mat keypoints_mat = new Mat();
            using Mat masks_mat = Converters.vector_Mat_to_Mat(masks);
        ...
        public void compute(List<Mat> images, List<MatOfKeyPoint> keypoints, List<Mat> descriptors)
        {
            ThrowIfDisposed();
            using Mat images_mat = Converters.vector_Mat_to_Mat(images);
            using Mat keypoints_mat = Converters.vector_vector_KeyPoint_to_Mat(keypoints);
            using Mat descriptors_mat = new Mat();
        ...
        public override string getDefaultName()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(features2d_Feature2D_getDefaultName_10(nativeObj)));
