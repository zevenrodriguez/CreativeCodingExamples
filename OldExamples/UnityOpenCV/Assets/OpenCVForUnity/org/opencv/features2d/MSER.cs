...
namespace OpenCVForUnity.Features2dModule
{
    ...
    public class MSER : Feature2D
    {
        ...
        public override string getDefaultName()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(features2d_MSER_getDefaultName_10(nativeObj)));
