...
namespace OpenCVForUnity.Features2dModule
{
    ...
    public class SimpleBlobDetector : Feature2D
    {
        ...
        public static SimpleBlobDetector create(SimpleBlobDetector_Params parameters)
        {
            ...
            return SimpleBlobDetector.__fromPtr__(DisposableObject.ThrowIfNullIntPtr(features2d_SimpleBlobDetector_create_10(parameters.getNativeObjAddr())));
        ...
        public void setParams(SimpleBlobDetector_Params _params)
        {
            ...
            features2d_SimpleBlobDetector_setParams_10(nativeObj, _params.getNativeObjAddr());
        ...
        public override string getDefaultName()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(features2d_SimpleBlobDetector_getDefaultName_10(nativeObj)));
