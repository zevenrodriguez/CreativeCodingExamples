...
namespace OpenCVForUnity.Features2dModule
{
    ...
    public class ORB : Feature2D
    {
        ...
        public override string getDefaultName()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(features2d_ORB_getDefaultName_10(nativeObj)));
