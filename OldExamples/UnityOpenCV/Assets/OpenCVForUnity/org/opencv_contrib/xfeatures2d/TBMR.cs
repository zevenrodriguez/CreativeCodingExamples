...
namespace OpenCVForUnity.Xfeatures2dModule
{
    ...
    /// </param>
    /// <param name="max_area_relative">
    /// prune areas bigger than maxArea = max_area_relative *
    ///  input_image_size
    /// </param>
    ...
    public class TBMR : AffineFeature2D
    {
        ...
        //
        // C++:  String cv::xfeatures2d::TBMR::getDefaultName()
        //
        ...
        public override string getDefaultName()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(xfeatures2d_TBMR_getDefaultName_10(nativeObj)));
        ...
        // C++:  String cv::xfeatures2d::TBMR::getDefaultName()
        [DllImport(LIBNAME)]
        private static extern IntPtr xfeatures2d_TBMR_getDefaultName_10(IntPtr nativeObj);
