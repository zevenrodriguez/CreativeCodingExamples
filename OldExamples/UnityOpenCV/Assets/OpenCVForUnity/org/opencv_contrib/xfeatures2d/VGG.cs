...
namespace OpenCVForUnity.Xfeatures2dModule
{
    ...
    /// </summary>
    /// <param name="desc">
    /// type of descriptor to use, VGG::VGG_120 is default (120 dimensions float)
    ///  Available types are VGG::VGG_120, VGG::VGG_80, VGG::VGG_64, VGG::VGG_48
    /// </param>
    /// <param name="isigma">
    /// gaussian kernel value for image blur (default is 1.4f)
    /// </param>
    /// <param name="img_normalize">
    /// use image sample intensity normalization (enabled by default)
    /// </param>
    /// <param name="use_orientation">
    ...
    public class VGG : Feature2D
    {
        ...
        public override string getDefaultName()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(xfeatures2d_VGG_getDefaultName_10(nativeObj)));
