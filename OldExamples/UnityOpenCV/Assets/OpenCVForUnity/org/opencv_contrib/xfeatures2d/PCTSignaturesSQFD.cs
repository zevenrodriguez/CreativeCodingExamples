...
namespace OpenCVForUnity.Xfeatures2dModule
{
    ...
    public class PCTSignaturesSQFD : Algorithm
    {
        ...
        /// </param>
        /// <param name="similarityParameter">
        ...
        /// </summary>
        /// <param name="_signature0">
        /// The first signature.
        /// </param>
        /// <param name="_signature1">
        ...
        public void computeQuadraticFormDistances(Mat sourceSignature, List<Mat> imageSignatures, MatOfFloat distances)
        {
            ...
            using Mat imageSignatures_mat = Converters.vector_Mat_to_Mat(imageSignatures);
