...
namespace OpenCVForUnity.Xfeatures2dModule
{
    ...
    /// </param>
    /// <param name="norm">
    /// choose descriptors normalization type, where
    ...
    public class DAISY : Feature2D
    {
        ...
        public override string getDefaultName()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(xfeatures2d_DAISY_getDefaultName_10(nativeObj)));
