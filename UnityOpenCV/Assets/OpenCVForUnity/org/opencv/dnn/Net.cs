...
namespace OpenCVForUnity.DnnModule
{
    ...
    public partial class Net : DisposableOpenCVObject
    {
        ...
        public string dump()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(dnn_Net_dump_10(nativeObj)));
        ...
        //
        // C++:  int cv::dnn::Net::addLayer(String name, String type, int dtype, LayerParams _params)
        //
        ...
        //
        // C++:  int cv::dnn::Net::addLayerToPrev(String name, String type, int dtype, LayerParams _params)
        //
        ...
        public int registerOutput(string outputName, int layerId, int outputPort)
        {
            ...
            return dnn_Net_registerOutput_10(nativeObj, outputName, layerId, outputPort);
        ...
        {
            ThrowIfDisposed();
            using Mat inputBlobNames_mat = Converters.vector_String_to_Mat(inputBlobNames);
        ...
        {
            ThrowIfDisposed();
            using Mat calibData_mat = Converters.vector_Mat_to_Mat(calibData);
        ...
        {
            ThrowIfDisposed();
            using Mat layersTypes_mat = new Mat();
        ...
        // C++:  int cv::dnn::Net::registerOutput(string outputName, int layerId, int outputPort)
        [DllImport(LIBNAME)]
        private static extern int dnn_Net_registerOutput_10(IntPtr nativeObj, string outputName, int layerId, int outputPort);
