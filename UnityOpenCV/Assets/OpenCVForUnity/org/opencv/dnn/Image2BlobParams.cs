...
namespace OpenCVForUnity.DnnModule
{
    ...
    public partial class Image2BlobParams : DisposableOpenCVObject
    {
        ...
        public Image2BlobParams(Scalar scalefactor, Size size, Scalar mean, bool swapRB, int ddepth, int datalayout, Scalar borderValue)
        {


            nativeObj = DisposableObject.ThrowIfNullIntPtr(dnn_Image2BlobParams_Image2BlobParams_11(scalefactor.val[0], scalefactor.val[1], scalefactor.val[2], scalefactor.val[3], size.width, size.height, mean.val[0], mean.val[1], mean.val[2], mean.val[3], swapRB, ddepth, datalayout, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]));


        }

        public Image2BlobParams(Scalar scalefactor, Size size, Scalar mean, bool swapRB, int ddepth, int datalayout)
        {


            nativeObj = DisposableObject.ThrowIfNullIntPtr(dnn_Image2BlobParams_Image2BlobParams_12(scalefactor.val[0], scalefactor.val[1], scalefactor.val[2], scalefactor.val[3], size.width, size.height, mean.val[0], mean.val[1], mean.val[2], mean.val[3], swapRB, ddepth, datalayout));
        ...
        public Image2BlobParams(Scalar scalefactor, Size size, Scalar mean, bool swapRB, int ddepth)
        {
            ...
            nativeObj = DisposableObject.ThrowIfNullIntPtr(dnn_Image2BlobParams_Image2BlobParams_14(scalefactor.val[0], scalefactor.val[1], scalefactor.val[2], scalefactor.val[3], size.width, size.height, mean.val[0], mean.val[1], mean.val[2], mean.val[3], swapRB, ddepth));
        ...
        public int get_datalayout()
        {
            ...
            return dnn_Image2BlobParams_get_1datalayout_10(nativeObj);
        ...
        public void set_datalayout(int datalayout)
        {
            ...
            dnn_Image2BlobParams_set_1datalayout_10(nativeObj, datalayout);
        ...
        public int get_paddingmode()
        {
            ...
            return dnn_Image2BlobParams_get_1paddingmode_10(nativeObj);
        ...
        public void set_paddingmode(int paddingmode)
        {
            ...
            dnn_Image2BlobParams_set_1paddingmode_10(nativeObj, paddingmode);
        ...
        // C++: dnn_DataLayout Image2BlobParams::datalayout
        [DllImport(LIBNAME)]
        private static extern int dnn_Image2BlobParams_get_1datalayout_10(IntPtr nativeObj);

        // C++: void Image2BlobParams::datalayout
        [DllImport(LIBNAME)]
        private static extern void dnn_Image2BlobParams_set_1datalayout_10(IntPtr nativeObj, int datalayout);

        // C++: dnn_ImagePaddingMode Image2BlobParams::paddingmode
        [DllImport(LIBNAME)]
        private static extern int dnn_Image2BlobParams_get_1paddingmode_10(IntPtr nativeObj);

        // C++: void Image2BlobParams::paddingmode
        [DllImport(LIBNAME)]
        private static extern void dnn_Image2BlobParams_set_1paddingmode_10(IntPtr nativeObj, int paddingmode);
