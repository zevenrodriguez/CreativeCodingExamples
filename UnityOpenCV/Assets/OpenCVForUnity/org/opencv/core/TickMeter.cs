...
namespace OpenCVForUnity.CoreModule
{
    ...
    public class TickMeter : DisposableOpenCVObject
    {
        ...
        public long getLastTimeTicks()
        {
            ...
            return core_TickMeter_getLastTimeTicks_10(nativeObj);
        ...
        public double getLastTimeMicro()
        {
            ...
            return core_TickMeter_getLastTimeMicro_10(nativeObj);
        ...
        public double getLastTimeMilli()
        {
            ...
            return core_TickMeter_getLastTimeMilli_10(nativeObj);
        ...
        public double getLastTimeSec()
        {
            ...
            return core_TickMeter_getLastTimeSec_10(nativeObj);
        ...
        // C++:  int64 cv::TickMeter::getLastTimeTicks()
        [DllImport(LIBNAME)]
        private static extern long core_TickMeter_getLastTimeTicks_10(IntPtr nativeObj);

        // C++:  double cv::TickMeter::getLastTimeMicro()
        [DllImport(LIBNAME)]
        private static extern double core_TickMeter_getLastTimeMicro_10(IntPtr nativeObj);

        // C++:  double cv::TickMeter::getLastTimeMilli()
        [DllImport(LIBNAME)]
        private static extern double core_TickMeter_getLastTimeMilli_10(IntPtr nativeObj);

        // C++:  double cv::TickMeter::getLastTimeSec()
        [DllImport(LIBNAME)]
        private static extern double core_TickMeter_getLastTimeSec_10(IntPtr nativeObj);
