...
namespace OpenCVForUnity.CoreModule
{
    ...
    public partial class Core
    {
        ...
        /// </summary>
        public const int ALGO_HINT_DEFAULT = 0;

        /// <summary>
        /// C++: enum AlgorithmHint (cv.AlgorithmHint)
        /// </summary>
        public const int ALGO_HINT_ACCURATE = 1;

        /// <summary>
        /// C++: enum AlgorithmHint (cv.AlgorithmHint)
        /// </summary>
        public const int ALGO_HINT_APPROX = 2;
        ...
        public static string getIppVersion()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(core_Core_getIppVersion_10()));
        ...
        {
            if (dst != null) dst.ThrowIfDisposed();
            using Mat mv_mat = Converters.vector_Mat_to_Mat(mv);
        ...
        public static void mixChannels(List<Mat> src, List<Mat> dst, MatOfInt fromTo)
        {
            ...
            using Mat src_mat = Converters.vector_Mat_to_Mat(src);
            using Mat dst_mat = Converters.vector_Mat_to_Mat(dst);
        ...
        /// </param>
        /// <param name="roots">
        /// output array of real roots that has 0, 1, 2 or 3 elements.
        /// </param>
        /// <returns>
        ...
        public static string getBuildInformation()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(core_Core_getBuildInformation_10()));
            string retVal = Marshal.PtrToStringAnsi(strPtr);
            UnityIntegration.OpenCVInternalUtils.FreeStringCopy(strPtr);
        ...
        public static string getVersionString()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(core_Core_getVersionString_10()));
            string retVal = Marshal.PtrToStringAnsi(strPtr);
            UnityIntegration.OpenCVInternalUtils.FreeStringCopy(strPtr);
        ...
        public static string getHardwareFeatureName(int feature)
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(core_Core_getHardwareFeatureName_10(feature)));
            string retVal = Marshal.PtrToStringAnsi(strPtr);
            UnityIntegration.OpenCVInternalUtils.FreeStringCopy(strPtr);
        ...
        public static string getCPUFeaturesLine()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(core_Core_getCPUFeaturesLine_10()));
            string retVal = Marshal.PtrToStringAnsi(strPtr);
            UnityIntegration.OpenCVInternalUtils.FreeStringCopy(strPtr);
        ...
        public static int getDefaultAlgorithmHint()
        {
            ...
            return core_Core_getDefaultAlgorithmHint_10();
        ...
        public static string findFile(string relative_path, bool required, bool silentMode)
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(core_Core_findFile_10(relative_path, required, silentMode)));
            string retVal = Marshal.PtrToStringAnsi(strPtr);
            UnityIntegration.OpenCVInternalUtils.FreeStringCopy(strPtr);
        ...
        public static string findFile(string relative_path, bool required)
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(core_Core_findFile_11(relative_path, required)));
            string retVal = Marshal.PtrToStringAnsi(strPtr);
            UnityIntegration.OpenCVInternalUtils.FreeStringCopy(strPtr);
        ...
        public static string findFile(string relative_path)
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(core_Core_findFile_12(relative_path)));
            string retVal = Marshal.PtrToStringAnsi(strPtr);
            UnityIntegration.OpenCVInternalUtils.FreeStringCopy(strPtr);
        ...
        public static string findFileOrKeep(string relative_path, bool silentMode)
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(core_Core_findFileOrKeep_10(relative_path, silentMode)));
            string retVal = Marshal.PtrToStringAnsi(strPtr);
            UnityIntegration.OpenCVInternalUtils.FreeStringCopy(strPtr);
        ...
        public static string findFileOrKeep(string relative_path)
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(core_Core_findFileOrKeep_11(relative_path)));
            string retVal = Marshal.PtrToStringAnsi(strPtr);
            UnityIntegration.OpenCVInternalUtils.FreeStringCopy(strPtr);
        ...
        // C++:  AlgorithmHint cv::getDefaultAlgorithmHint()
        [DllImport(LIBNAME)]
        private static extern int core_Core_getDefaultAlgorithmHint_10();
