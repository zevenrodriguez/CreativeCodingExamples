...
namespace OpenCVForUnity.Features2dModule
{
    ...
    public class AffineFeature : Feature2D
    {
        ...
        public override string getDefaultName()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(features2d_AffineFeature_getDefaultName_10(nativeObj)));
