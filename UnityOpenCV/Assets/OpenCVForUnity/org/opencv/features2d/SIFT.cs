...
namespace OpenCVForUnity.Features2dModule
{
    ...
    public class SIFT : Feature2D
    {
        ...
        /// </param>
        /// <param name="enable_precise_upscale">
        ...
        public override string getDefaultName()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(features2d_SIFT_getDefaultName_10(nativeObj)));
