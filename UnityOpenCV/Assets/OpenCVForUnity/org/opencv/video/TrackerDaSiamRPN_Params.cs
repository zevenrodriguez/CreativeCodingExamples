...
namespace OpenCVForUnity.VideoModule
{
    ...
    public class TrackerDaSiamRPN_Params : DisposableOpenCVObject
    {
        ...
        public string get_model()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(video_TrackerDaSiamRPN_1Params_get_1model_10(nativeObj)));
        ...
        public string get_kernel_cls1()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(video_TrackerDaSiamRPN_1Params_get_1kernel_1cls1_10(nativeObj)));
            string retVal = Marshal.PtrToStringAnsi(strPtr);
            UnityIntegration.OpenCVInternalUtils.FreeStringCopy(strPtr);
        ...
        public string get_kernel_r1()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(video_TrackerDaSiamRPN_1Params_get_1kernel_1r1_10(nativeObj)));
            string retVal = Marshal.PtrToStringAnsi(strPtr);
            UnityIntegration.OpenCVInternalUtils.FreeStringCopy(strPtr);
