...
namespace OpenCVForUnity.VideoModule
{
    ...
    public class TrackerNano_Params : DisposableOpenCVObject
    {
        ...
        public string get_backbone()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(video_TrackerNano_1Params_get_1backbone_10(nativeObj)));
        ...
        public string get_neckhead()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(video_TrackerNano_1Params_get_1neckhead_10(nativeObj)));
            string retVal = Marshal.PtrToStringAnsi(strPtr);
            UnityIntegration.OpenCVInternalUtils.FreeStringCopy(strPtr);
