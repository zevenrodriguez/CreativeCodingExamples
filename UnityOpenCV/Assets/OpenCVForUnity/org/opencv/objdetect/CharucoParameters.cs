...
namespace OpenCVForUnity.ObjdetectModule
{
    ...
    public class CharucoParameters : DisposableOpenCVObject
    {
        ...
        public bool get_checkMarkers()
        {
            ThrowIfDisposed();

            return objdetect_CharucoParameters_get_1checkMarkers_10(nativeObj);
        ...
        public void set_checkMarkers(bool checkMarkers)
        {
            ThrowIfDisposed();

            objdetect_CharucoParameters_set_1checkMarkers_10(nativeObj, checkMarkers);
        ...
        [DllImport(LIBNAME)]
        [return: MarshalAs(UnmanagedType.U1)]
        private static extern bool objdetect_CharucoParameters_get_1checkMarkers_10(IntPtr nativeObj);
