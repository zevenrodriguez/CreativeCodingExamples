...
namespace OpenCVForUnity.Xfeatures2dModule
{
    ...
    public class HarrisLaplaceFeatureDetector : Feature2D
    {
        ...
        public override string getDefaultName()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(xfeatures2d_HarrisLaplaceFeatureDetector_getDefaultName_10(nativeObj)));
