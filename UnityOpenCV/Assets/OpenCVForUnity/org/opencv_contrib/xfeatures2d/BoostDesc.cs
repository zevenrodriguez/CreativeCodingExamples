...
namespace OpenCVForUnity.Xfeatures2dModule
{
    ...
    /// </summary>
    /// <param name="desc">
    /// type of descriptor to use, BoostDesc::BINBOOST_256 is default (256 bit long dimension)
    ...
    public class BoostDesc : Feature2D
    {
        ...
        public override string getDefaultName()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(xfeatures2d_BoostDesc_getDefaultName_10(nativeObj)));
