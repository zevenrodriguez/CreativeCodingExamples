...
namespace OpenCVForUnity.Xfeatures2dModule
{
    ...
    public class FREAK : Feature2D
    {
        ...
        /// <param name="orientationNormalized">
        /// Enable orientation normalization.
        /// </param>
        /// <param name="scaleNormalized">
        ...
        public override string getDefaultName()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(xfeatures2d_FREAK_getDefaultName_10(nativeObj)));
