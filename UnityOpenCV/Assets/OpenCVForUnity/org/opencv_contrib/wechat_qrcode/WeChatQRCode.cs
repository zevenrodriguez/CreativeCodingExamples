...
namespace OpenCVForUnity.Wechat_qrcodeModule
{
    ...
    public class WeChatQRCode : DisposableOpenCVObject
    {
        ...
        /// </summary>
        /// <param name="detector_prototxt_path">
        /// prototxt file path for the detector
        /// </param>
        /// <param name="detector_caffe_model_path">
        /// caffe model file path for the detector
        /// </param>
        /// <param name="super_resolution_prototxt_path">
        /// prototxt file path for the super resolution model
        /// </param>
        /// <param name="super_resolution_caffe_model_path">
