...
namespace OpenCVForUnity.BioinspiredModule
{
    ...
    public partial class TransientAreasSegmentationModule : Algorithm
    {
        ...
        public string printSetup()
        {
            ...
            IntPtr strPtr = DisposableObject.ThrowIfNullIntPtr(DisposableObject.ThrowIfNullIntPtr(bioinspired_TransientAreasSegmentationModule_printSetup_10(nativeObj)));
